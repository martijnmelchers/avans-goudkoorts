    ...
    public class GoudKoorts
    {
        ...
        private void LoadDemoList()
        {
            ...
            List<List<PlacableObject>> columns = new List<List<PlacableObject>>
            {
                ...
                new List<PlacableObject>{new RemoverTrack(Direction.LEFT),new Track(Direction.LEFT),new Track(Direction.LEFT),new Track(Direction.LEFT),new Track(Direction.LEFT),new Track(Direction.LEFT),new Track(Direction.LEFT),new Track(Direction.LEFT),new Track(Direction.LEFT),new Track(Direction.LEFT),new Track(Direction.LEFT),new Track(Direction.LEFT)},
